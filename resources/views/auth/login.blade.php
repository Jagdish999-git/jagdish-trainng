            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">BABA ART</h3>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <label>Email</label>
                    <div class="mb-3">
                    <input type="email" id="form3Example3" name="email" class="form-control  @error('email') is-invalid @enderror" value="{{ old('email') }}" aria-describedby="email-addon" required autocomplete="email" autofocus
