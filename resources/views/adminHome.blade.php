  ...
  <body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        ...
        <li class="nav-item">
            <a class="nav-link text-white " href="{{url('admin.tables')}}">
                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="mb-0"><span>{{ \App\Models\User::all()->count() }}</span></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="../../js/material-dashboard.min.js?v=3.0.4"></script>
  </body>
