...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <span class="ms-1 font-weight-bold text-white">BABAART</span>
            </a>
        </div>
                ...
                @else
					...
					@endphp
						<li class="nav-item dropdown">
							<a id="navbarDropdown" class="nav-link dropdown-toggle text-body font-weight-bold px-0" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
							 <span class="d-sm-inline d-none">{{ Auth::user()->name }} </span><img src="{{asset('images/'.$adminData->image)}} "
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <table class="table align-items-center mb-0">
                 <thead>
                 <tr><th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Sr no</th>
                  ...
                  <tbody>
                    <tr>
                     ...
                     <td>
                          <img src="{{asset('images/'.$users->image)}} " class="avatar avatar-sm me-4 border-radius-lg" alt="user1">
                      ...
                      <td >
                         <p class="text-xs font-weight-bold mb-0">{{$users->phone}}</p>
                      </td>
                      <td >
                        <span class="text-secondary text-xs font-weight-bold">{{$users->city}}</span>
                      </td>
                       <td >
                        <span class="text-secondary text-xs font-weight-bold">{{$users->designation}}</span>
                      </td>
                      <td >
                        <span class="badge badge-sm bg-gradient-success">{{$users->type}}</span>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
